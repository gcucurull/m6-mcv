...
% figure;
% plotmatches(im1rgb, im2rgb, points_1(1:2,:), points_2(1:2,:), matches_1_2, 'Stacking', 'v');
% p1 and p2 contain the homogeneous coordinates of the matches
p12 = [points_1(1:2, matches_1_2(1,:)); ones(1, length(matches_1_2))];
p21 = [points_2(1:2, matches_1_2(2,:)); ones(1, length(matches_1_2))];
[F_1_2, inliers_1_2] = ransac_fundamental_matrix(p12, p21, 2.0); 

% % figure;
% % plotmatches(im2rgb, im3rgb, points_2(1:2,:), points_3(1:2,:), matches_2_3, 'Stacking', 'v');
% % p2 and p3 contain the homogeneous coordinates of the matches
 p13 = [points_1(1:2, matches_1_3(1,:)); ones(1, length(matches_1_3))];
 p31 = [points_3(1:2, matches_1_3(2,:)); ones(1, length(matches_1_3))];
 [F_1_3, inliers_1_3] = ransac_fundamental_matrix(p13, p31, 2.0); 
% 
% % figure;
% % plotmatches(im3rgb, im4rgb, points_3(1:2,:), points_4(1:2,:), matches_3_4, 'Stacking', 'v');
% % p3 and p4 contain the homogeneous coordinates of the matches
p14 = [points_1(1:2, matches_1_4(1,:)); ones(1, length(matches_1_4))];
p41 = [points_4(1:2, matches_1_4(2,:)); ones(1, length(matches_1_4))];
[F_1_4, inliers_1_4] = ransac_fundamental_matrix(p14, p41, 2.0); 

% Plot the car trajectory (keypoint idx_car_I1 in image 1)

% ToDo: complete the code
idx_car_I1 = 1197;
match_index = find(matches_1_2(1,:) == idx_car_I1);
idx_car_I2 = matches_1_2(2,match_index); % ToDo: identify the corresponding point of idx_car_I1 in image 2
match_index = find(matches_1_3(1,:) == idx_car_I1);
idx_car_I3 = matches_1_3(2,match_index);  % ToDo: identify the corresponding point of idx_car_I1 in image 3
match_index = find(matches_1_4(1,:) == idx_car_I1);
idx_car_I4 = matches_1_4(2,match_index);% ToDo: identify the corresponding point of idx_car_I1 in image 4
